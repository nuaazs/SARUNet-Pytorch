...
# @Describe: define options used during training time.
...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_id', type=int, default=3,
        ...
        parser.add_argument('--display_port', type=int,
                            default=8093, help='visdom port of the web display')
        ...
        parser.add_argument('--single_k_index', type=int, default=-1,
                            help='')
        self.isTrain = True
        return parser
