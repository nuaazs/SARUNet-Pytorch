...
# @Describe: define options used during both training and test time.
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='generate',
        ...
        parser.add_argument('--netG', type=str, default='SARU',
        ...
        parser.add_argument('--k_fold', type=int,
                            default=5, help='k-fold number')
        parser.add_argument('--display_val_test', action='store_true',
                            default=True, help='')
        ...
        parser.add_argument('--style_loss', action='store_true',
                            help='use style_loss or not')
        #parser.add_argument('--continue_train', default=0, type=int, help='')
        parser.add_argument('--filetype', default='img', type=str,
                            help='default 2d img(png files), you can use npy or nii.gz for other type of inputs. [img | 4dct]')
        parser.add_argument('--dream', type=float,
                            default=0.0, help='flooding index')
