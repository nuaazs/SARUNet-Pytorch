...
class GenerateModel(BaseModel):
    ...
    def get_test_score(self,opt,loader,visualizer,pic_name,win_id,save_png):
        #net.eval()
        if save_png:
            os.makedirs(f"/home/zhaosheng/paper2/online_code/cbamunet-pix2pix/results/{opt.name}/temp_pics/k{opt.k_index}_{opt.now_epoch}/",exist_ok=True)
            ...
            for batch in loader:
                ...
                for xx in range(self.fake_B.shape[0]):
                    ...
                    if save_png:
                        ...
                        real_ct_im.save(f"/home/zhaosheng/paper2/online_code/cbamunet-pix2pix/results/{opt.name}/temp_pics/k{opt.k_index}_{opt.now_epoch}/{pic_file_name}_real_B.png")
                        fake_ct_im.save(f"/home/zhaosheng/paper2/online_code/cbamunet-pix2pix/results/{opt.name}/temp_pics/k{opt.k_index}_{opt.now_epoch}/{pic_file_name}_fake_B.png")
