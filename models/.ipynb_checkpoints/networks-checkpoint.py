...
# @Describe: Some of the common modules of the network are defined here, as well as the selection functions of generators and discriminators.
...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=True, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    if netG == 'unet':
        ...
        net = ResnetGenerator(input_nc, output_nc, use_attn=False, ngf=ngf,
