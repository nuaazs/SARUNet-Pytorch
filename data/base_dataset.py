...
def get_transform(opt, params, degree, grayscale=False, method=Image.BICUBIC, convert=True, is_input=False,is_train=True):
    transform_list = []
    if not is_train:
    ...
    if not opt.no_flip:  # and opt.preprocess != 'none':
        # if params is None:
