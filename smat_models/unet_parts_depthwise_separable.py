...
from smat_models.layers import DepthwiseSeparableConv
...
class UpDS(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, bilinear=True, kernels_per_layer=1):
        super().__init__()
        self.resconv = nn.Sequential(nn.Conv2d(in_channels, out_channels, kernel_size=1),nn.BatchNorm2d(out_channels),nn.ReLU(inplace=True))
    ...
    def forward(self, x1, x2):
        ...
        return self.conv(x)+self.resconv(x)
