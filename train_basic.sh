...
&& \
python train.py --netG resnet --netD basic --mode pix2pix --name bs10_resnet _basic --display_port 8097 --gpu_ids 1 --display_id 0  --save_epoch_freq 50 --print_freq 1000 --batch_size 10\
&& \
python train.py --netG attnresnet --netD basic --mode pix2pix --name bs10_attnresnet _basic --display_port 8097 --gpu_ids 1 --display_id 0  --save_epoch_freq 50 --print_freq 1000 --batch_size 10\
&& \
python train.py --netG resunet --netD basic --mode pix2pix --name bs10_resunet _basic --display_port 8097 --gpu_ids 1 --display_id 0  --save_epoch_freq 50 --print_freq 1000 --batch_size 10\
&& \
python train.py --netG resunetpp --netD basic --mode pix2pix --name bs10_resunetpp _basic --display_port 8097 --gpu_ids 1 --display_id 0  --save_epoch_freq 50 --print_freq 1000 --batch_size 10\
