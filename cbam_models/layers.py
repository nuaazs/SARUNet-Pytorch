...
class DoubleDense(nn.Module):
    ...
    def forward(self, x):
        out = F.LeakyReLU(self.dense1(x.view(x.size(0), -1)))
        out = F.LeakyReLU(self.dense2(out))
        out = self.dense3(out)
        return out
...
class SpatialAttention(nn.Module):
    def __init__(self, kernel_size=7):
        ...
        # self.conv1 = nn.Conv2d(2, 16, kernel_size=kernel_size, padding=padding, bias=False)
        # self.relu1 = nn.LeakyReLU()
        # # self.maxpool1 = nn.AdaptiveMaxPool2d(16)

        # self.conv2 = nn.Conv2d(16, 32, kernel_size=kernel_size, padding=padding, bias=False)
        # self.relu2 = nn.LeakyReLU()
        # # self.maxpool2 = nn.AdaptiveMaxPool2d(32)

        # self.conv3 = nn.Conv2d(32, 64, kernel_size=kernel_size, padding=padding, bias=False)
        # self.relu3 = nn.LeakyReLU()
        # # self.maxpool3 = nn.AdaptiveMaxPool2d(64)
